...
def run(selected_keywords):
    ...
    # CLICK FT. LAUDERDALE
    ft_lauderdale = driver.find_element(By.XPATH, '//*[@id="choseCityContainer"]/div[3]/article/div[10]/article/p[2]/a')
    driver.execute_script("arguments[0].click();", ft_lauderdale)
    driver.implicitly_wait(10)
    ...
    for link in links:
        ...
        for keyword in selected_keywords:
            ...
            if keyword in description.lower():
                ...
                screenshot_dir = pathlib.Path.home() / f"Desktop/megapersonals/ft_lauderdale/screenshots/{timestamp}"
    ...
    excel_dir = pathlib.Path.home() / f"Desktop/megapersonals/ft_lauderdale/excel_files/{timestamp}"
