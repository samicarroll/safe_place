...
def run(selected_keywords):
    ...
    LIST = []
    url = 'https://skipthegames.com/posts/sarasota/'
    ...
    for urls in links:
        ...
        for keyword in selected_keywords:
            if keyword in description:
                ...
                screenshot_dir = pathlib.Path.home() / f"Desktop/skipthegames/sarasota/screenshots/{timestamp}"
    ...
    excel_dir = pathlib.Path.home() / f"Desktop/skipthegames/sarasota/excel_files/{timestamp}"
