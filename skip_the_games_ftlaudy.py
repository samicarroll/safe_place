...
def run(selected_keywords):
    ...
    LIST = []
    url = 'https://skipthegames.com/posts/fort-lauderdale/'
    ...
    for urls in links:
        ...
        for keyword in selected_keywords:
            if keyword in description:
                ...
                screenshot_dir = pathlib.Path.home() / f"Desktop/skipthegames/fort lauderdale/screenshots/{timestamp}"
    ...
    excel_dir = pathlib.Path.home() / f"Desktop/skipthegames/fort lauderdale/excel_files/{timestamp}"
