...
with open('static/keywords.txt') as f:
...
for link in links:
    ...
    for keyword in keywords:
        ...
        if keyword in description.lower():
            ...
            screenshot_dir = pathlib.Path.home() / f"Desktop/megapersonals/miami/screenshots/{timestamps}"
...
excel_dir = pathlib.Path.home() / f"Desktop/megapersonals/miami/excel_files/{timestamps}"
os.mkdir(excel_dir)
